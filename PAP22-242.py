...
pltext.plotdata(f_1,U_A1,U_A1_dsys,f_1_dsys,label='R=680kOhm')
pltext.plotdata(f_1,U_A2,U_A2_dsys,f_1_dsys,label='R=274kOhm')
pltext.plotdata(f_1,U_A3,U_A3_dsys,f_1_dsys,label='R=48.7kOhm')
pltext.plotdata(f_1,U_A4,U_A4_dsys,f_1_dsys,label='mit C')

pltext.initplot(num=2,xlabel='Frequenz in Hz',ylabel='Spannung in V',scale='loglog')
pltext.plotdata(f_2,U_A5,U_A5_dsys,f_2_dsys)
