...
print(sig("Deviation ", k_e_w, k_e_w, k_t_w, k_t_w))
...
print(sig("Deviation ", k_e_m, k_e_m, k_t_m, k_t_m))
...
print(sig("Deviation ", k_e_s, k_e_s, k_t_s, k_t_s))
...
[g, dg, b, db, plt] = linreg(l2, k, dk, dl2, drawplot=True, xlabel="l^2 in m^2", ylabel="coupling constant k")
